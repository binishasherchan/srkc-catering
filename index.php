 ...
 ?>
  ...
  <main id="main">
    ...
    <section class="video-wrapper">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12 p-0">
                        <div class="story-video main-video">
                            <img class="video-img" src="assets/img/banner-bg.jpg" alt="">
                            <div class="play-btn">
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                        <div class="counter-info">
                            <div class="counter-wrap">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6 counter1">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6 counter2">
                                        <div class="counter-section">
                                            <div class="counter-section-inner">
                                                <span>
                                                    <img src="assets/img/icon/chef.png" alt="">
                                                </span>
                                                <h4>109</h4>
                                                <p>Expert Chefs</p>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6 counter3">
                                        <div class="counter-section">
                                            <div class="counter-section-inner">
                                                <span>
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6 counter4">
                                        <div class="counter-section">
                                            <div class="counter-section-inner">
                                                <span>
                                                    <img src="assets/img/icon/event.png" alt="">
                                                </span>
                                                <h4>235</h4>
        ...
        <section class="service-wrapper has-bg relative">
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <div class="service-section">
                            <div class="service-inner">
                                <div class="service-img">
                                    <img src="assets/img/icon/couple.png" alt="">
                                </div>
                                <div class="service-info">
                                    ...
                                    <a href="javascript:void(0);" class="link">
                                        ...
                                        <span>
                                            ...
                                            y="0px"
                                             width="28" height="18" viewBox="0 0 28 18" xml:space="preserve">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="service-section">
                            <div class="service-inner">
                                <div class="service-img">
                                    <img src="assets/img/icon/catering.png" alt="">
                                </div>
                                <div class="service-info">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="service-section">
                            <div class="service-inner">
                                <div class="service-img">
                                    <img src="assets/img/icon/cocktail.png" alt="">
                                </div>
                                <div class="service-info">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="service-section">
                            <div class="service-inner">
                                <div class="service-img">
                                    <img src="assets/img/icon/buffet.png" alt="">
                                </div>
                                <div class="service-info">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="member-info">
                <h4>Jeewan Bhandari</h4>
                <span>Banquet Manager</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="member-img">
                <img src="assets/img/team/02.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
